...
#define LOG_DATA_SIZE_TIM 1 //Time based size. Can record for 50 seconds every 10 ms. max 5000
#define LOG_DATA_SIZE_TIM2 1 //Time based size. Can record for 50 seconds every 10 ms
